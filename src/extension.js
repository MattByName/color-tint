 ...
 * Should ONLY be used for operations that can only be done once and can not be undone.
 * See https://gjs.guide/extensions/review-guidelines/review-guidelines.html#only-use-init-for-initialization
 */
function init() {
